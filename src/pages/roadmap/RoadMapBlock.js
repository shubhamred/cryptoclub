...
import { RoadmapSectionMain } from './RoadmapSectionMain'
import { Roadmap_content } from './Roadmap_content'
import { Roadmap_footer } from './Roadmap_footer'
import '../../pages/mintpage/restrictedarea/restricted.scss'
import gkdsl from '../../assets/images/girl1.png'
import gkdpp from '../../assets/images/girl3.png'
import jjhhj from '../../assets/images/girl2.png'
import table from '../../assets/images/Group 122.png'

export const RoadMapBlock = (props) => {
    return (
        <>
          <Header/>
            <MidiumTerm MidTermTopHeading="ROADMAP"/>
            <div className='container-mainbg container'>
            <RoadmapSectionMain/>

            {/* <div className="container GirlsImageDiv community-box ourStory" id="roadMp">   */}
          
            <div className='community-box '>
           <div className="row clearfix"> 
            <div className="col-md-4 col-12">
            <img src={gkdsl} alt="" className="center-block img-fluid" />
           </div>
            
            
            <div className="col-md-4 col-12">
                <img src={gkdpp} alt=""  className="center-block img-fluid" />
            </div>
            
            <div className="col-md-4 col-12">
                <img src={jjhhj} alt=""  className="center-block img-fluid" />
            </div>
        </div>
        </div>
        ...
        <div className="restrict1 clearfix restriROad">
        ...
        <div className="container Roadmap_content">
            <div className="row">
                <h5 className="medium_heading term ">Long Term Plans</h5>
                ...
                <div className="col-md-4 col-12">
                    ...
                    card_text="Here’s where 50% of all the project funds go to, and it will be used as the main cash flow for growth, development and new fun experiences.cash flow for growth, development and new fun experiences.cash flow for growth"
                    />
                </div>
            </div>
            ...
            <p className="text-center text-white join_text">Join our Discord Server for releasing dates and to mint your Crypto<br></br> Sluts before anyone else!</p>
            <img src={lakfklg} alt="" className=" img-fluid center-block " />
            </div>
