...
import bartable from '../../assets/images/Group 122.png'
import { ReactSVG } from "react-svg";

export const Roadmap_footer = () => {
    return (
      <div className='roadmap_maindiv'>
        
        <div className=" roadmap_footer" id="roadmap_foot">
        <div className="roamap-clear"><img src={bartable} className="bartable" /></div>
        ...
        <div className="footerbg">
          ...
          <Nav className="justify-content-center footer_links" activeKey="/home">
             ...
             <span className="footer_right_border"></span>
             <Nav.Link eventKey="link-6">VIP</Nav.Link>
          </Nav>
